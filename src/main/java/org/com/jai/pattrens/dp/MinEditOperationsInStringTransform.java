...
public class MinEditOperationsInStringTransform {
    ...
    private static int editOperationsImpl(String s1, String s2, int n, int m) {
        ...
        return 1 + Math.min(Math.min(editOperationsImpl(s1,s2,n-1,m-1),
                editOperationsImpl(s1,s2,n,m-1)),editOperationsImpl(s1,s2,n-1,m));
    }
