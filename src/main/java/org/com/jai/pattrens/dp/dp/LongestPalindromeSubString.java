...
public class LongestPalindromeSubString {
    ...
    public static int lpSubStringTopDown(String str, int start, int end, Integer[][] arr){
        ...
        if (arr[start][end] == null){
            ...
            return arr[start][end] = Math.max(lpSubStringTopDown(str,start-1,end,arr),
                    lpSubStringTopDown(str,start,end-1,arr));
        }
    ...
    public static void main(String[] args) {
        ...
        System.out.println(LongestPalindromeSubString.lpSubStringTopDown(str, 0, str.length() - 1, arr));
